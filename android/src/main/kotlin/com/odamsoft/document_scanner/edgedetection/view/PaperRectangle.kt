package com.odamsoft.document_scanner.edgedetection.view
...
class PaperRectangle : View {
    ...
    private val TAG: String = "PaperRectangle"
...
//    private var latestDownY = 0.0F
    ...
    init {
        ...
        fillPaint.color = Color.argb(100, 115, 194, 218)

        strokePaint.isAntiAlias = true
        strokePaint.isDither = true
        strokePaint.strokeWidth = 3F
        strokePaint.style = Paint.Style.STROKE
        strokePaint.color = Color.rgb(115, 194, 218)
        strokePaint.strokeJoin = Paint.Join.MITER   // set the join to round you want
        strokePaint.strokeCap = Paint.Cap.SQUARE      // set the paint cap to round too
